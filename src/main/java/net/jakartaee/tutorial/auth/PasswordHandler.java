...
//	}
	...
	public void checkPassword(String savedHash, String password ) throws AuthnException {
		String checkHash = getPasswordHash( password);
		if( !savedHash.equals(checkHash) ) throw new AuthnException("Password is not correct.");
	}
